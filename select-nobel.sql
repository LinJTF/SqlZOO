/*
1° - Show Nobel prizes winners for 1950.
*/
...
SELECT yr, subject, wninner
FROM nobel
WHERE subject = 'Literature'
AND (yr >= 1980 AND yr <= 1989)

/*
6° - Show all details of the presidetial winners:
- Theodore Roosevelt
- Woodrow Wilson
- Jimmy Carter
- Barack Obama
...
/*
14° - Show the 1984 winners and subject and winner name; but list Chemistry and Physics last.
*/
